...
**Event pillar / track:** Financial Intelligence
...
- Three panels in two minutes — demo script must call the drill-down, the verification badges, and the approve→forecast loop in that order without stalling.
